        ...
        <table className="table-auto w-full border-collapse">
          ...
          <tbody>
            ...
            <tr className="hover:bg-gray-50">
              ...
              <td className="py-2 px-2 md:px-4 border-b  text-green-700 ">
                <a href="
https://drive.google.com/file/d/19Uq1MIh5AHrAx064kTVOBIGCzlyPtpAC/view?usp=sharing"  style={{color:"#b17f27"}}>
                  Download/View
                </a>
              </td>
              {/* <Action /> */}
...
and Cluster Head</b>
              ...
              <td className="py-2 px-2 md:px-4 border-b">Sales Department</td>
              <td className="py-2 px-2 md:px-4 border-b">
              <b>Area Sales Manager</b>: Incentivized based on achieving area-specific sales targets and revenue goals.
              <br/>
<b>Senior Area Sales Manager</b>: Incentivized on area team performance and strategic sales initiatives.
<br/>
<b>Cluster Head</b>: Incentivized based on overall cluster growth, profitability, and leadership effectiveness.
              </td>
              <td className="py-2 px-2 md:px-4 border-b">14th October 2024</td>
              <td className="py-2 px-2 md:px-4 border-b text-green-700 ">
