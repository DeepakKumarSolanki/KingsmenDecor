  ...
  return (
    ...
    <div className="flex flex-col md:flex-row justify-between items-center p-4 mb-6 border-solid">
      <div className="text-center md:text-left">
        <h6 className="text-2xl font-semibold text-[#b17f27]">Holidays</h6>
        <div className="text-sm text-[#b17f27]">
  ...
  sx={{
    ...
    "&:hover": {
      backgroundColor: isPastHoliday
        ? "#f3f3f3"
        : isUpcoming
        ? "#c8e6c9" // Lighter green when hovered
        : "inherit",
    },
  }}
>
